...
android {
    namespace = "com.winlauncher.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.winlauncher.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        ...
        ndk {
            // MVP targets 64-bit ARM only (Mali/Adreno devices this project cares about).
...
dependencies {
    ...
    // Pinned to the pre-2.0 line deliberately -- see ArchiveExtractor's doc for why.
